...
A \emph{vector space} is a set \(V\) with two operations, vector addition and scalar multiplication, such that:
...
The uniqueness follows immediately from Remark 3.100. We prove the existence by induction on 
