...
\begin{enumerate}[label=\Roman*.]
    \item \textbf{Line Postulate:} A straight line segment can be drawn joining any two points.
    
    \item \textbf{Extension Postulate:} Any straight line segment can be extended indefinitely in a straight line.
    
    \item \textbf{Circle Postulate:} Given any straight line segment, a circle can be drawn having the segment as radius and one endpoint as center.
    
    \item \textbf{Right Angle Postulate:} All right angles are congruent.
    
    \item \textbf{Parallel Postulate:} If a line segment intersects two straight lines and makes the interior angles on the same side less than two right angles, then the two lines, if extended indefinitely, meet on that side.
\end{enumerate}
