...
If \emph{A}, \emph{B}, and \emph{c} are points on a circle where the line \( AC \) is the diameter, 
then the angle \( \angle ABC \) is a right angle.
...
\begin{center}
	...
	\draw[thick] (0,0) -- (2,3.5) node[midway, left] {\emph{b}};
	\draw[thick] (5,0) -- (2,3.5) node[midway, right] {\emph{a}};
	\node[below left] at (0,0) {\emph{A}};
	\node[below right] at (5,0) {\emph{B}};
	\node[above] at (2,3.5) {\emph{C}};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\draw[thick] (A) -- (C) node[midway, left] {\emph{b}};
	\draw[thick] (B) -- (C) node[midway, right] {\emph{a}};
	\pic["\(\theta\)", draw=black, angle radius=1cm, angle eccentricity=1.3] {angle=B--A--C};
	\node[below left] at (A) {\emph{A}};
	\node[below right] at (B) {\emph{B}};
	\node[above] at (C) {\emph{C}};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\coordinate (C) at (4,0);
	\coordinate (B) at (2,3);
	\draw[thick] (A) -- (C) node[midway, below] {\emph{b}};
	\draw[thick] (A) -- (B);
	\draw[thick] (B) -- (C);
	...
	\node[below left] at (A) {\emph{A}};
	\node[below right] at (C) {\emph{C}};
	\node[above] at (B) {\emph{B}};
	\end{tikzpicture}
\end{center}
...
\begin{center}
	...
	\draw[thick] (A) -- (B1) node[midway, left] {\emph{b}};
	\draw[thick] (A) -- (B2) node[midway, left] {\emph{b}};
...
where \emph{a} and \emph{b} are segments on one ray, and \(a'\), \(b'\) are the corresponding segments on the 
other ray.
...
\begin{center}
	\begin{tikzpicture}[scale=1.2]
		...
		% Points
		\node at (-0.2,0) {\(S\)};
		\node[above] at (1,0.4) {\emph{A}};
		\node[below] at (1,-0.5) {\emph{B}};
...
\begin{center}
	\begin{tikzpicture}[scale=1.2]
		...
		% Points
		\node at (-0.2,0) {\(S\)};
		\node[above left] at (1,0.5) {\emph{A}};
		\node[below left] at (1,-0.5) {\emph{B}};
