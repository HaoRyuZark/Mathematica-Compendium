...
\begin{itemize}[label=\(-\)]
\item \textbf{Sum Rule:} \(\displaystyle \lim_{x \to a} (f(x) + g(x)) = \lim_{x \to a} f(x) + \lim_{x \to a} g(x)\)
\item \textbf{Difference Rule:} \(\displaystyle \lim_{x \to a} (f(x) - g(x)) = \lim_{x \to a} f(x) - \lim_{x \to a} g(x)\)
\item \textbf{Product Rule:} \(\displaystyle \lim_{x \to a} (f(x)g(x)) = \lim_{x \to a} f(x) \cdot \lim_{x \to a} g(x)\)
\item \textbf{Quotient Rule:} \(\displaystyle \lim_{x \to a} \frac{f(x)}{g(x)} = \frac{\lim f(x)}{\lim g(x)}\) if \(\lim g(x) \ne 0\)
\item \textbf{Power Rule:} \(\displaystyle \lim_{x \to a} f(x)^n = (\lim_{x \to a} f(x))^n\)
\item \textbf{Root Rule:} \(\displaystyle \lim_{x \to a} \sqrt[n]{f(x)} = \sqrt[n]{\lim_{x \to a} f(x)}\) (when defined)
\end{itemize}
...
\subsubsection{Example of a limit using e}
...
In other words, a function can have at most one limit at a given point. This is the \textbf{uniqueness of limits}.
...
\noindent\textbf{Conclusion:} Our assumption was false. Hence, \( L_1 = L_2 \). The limit is unique.
