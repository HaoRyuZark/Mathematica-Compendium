...
\subsubsection*{Example 1: \( \int \frac{1}{\sqrt{4 - x^2}} \,dx \)}
...
\subsubsection*{Example 2: \( \int \frac{x^3}{\sqrt{x^2 + 4}} \,dx \)}
...
\subsubsection*{Example 3: \( \int \frac{x^3}{\sqrt{x^4 - 4}} \,dx \)}
...
\]
\item \textbf{Area between curves:}
\[
A = \int_a^b |f(x) - g(x)|\,dx
\]
\item \textbf{Volume (disk):}
\[
